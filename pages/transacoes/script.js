...
// Garante que o código só roda quando o DOM estiver pronto
document.addEventListener('DOMContentLoaded', function () {
    // Seleciona o elemento pelo ID (troca pelo ID correto do teu elemento)
    const meuElemento = document.getElementById('tituloTransacao');
    if (meuElemento) {
        meuElemento.addEventListener('input', function () {
            // ...teu código aqui...
        });
    } else {
        console.warn('Elemento #tituloTransacao não encontrado no DOM');
    }
